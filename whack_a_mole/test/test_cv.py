...
@pytest.fixture
def opencv_client():
    """Return an OpenCVClient instance."""
    return OpenCVClient()


def test_initialization(opencv_client):
    """Test the initialization of the OpenCVClient."""
...
def test_camera_intrinsics(opencv_client):
    """Test setting and getting the camera intrinsics."""
...
def test_color_image(opencv_client):
    """Test setting and getting the color image."""
...
def test_depth_image(opencv_client):
    """Test setting and getting the depth image."""
...
def test_find_centroid_cropped(opencv_client):
    """Test finding the centroid of a contour in a cropped image."""
...
def test_get_3d_coordinates_at_pixel(opencv_client):
    """Test getting the 3D coordinates at a pixel."""
    intrinsics = np.array([600, 0, 320, 0, 600, 240, 0, 0, 1])
    opencv_client.camera_intrinsics = intrinsics
...
def test_get_3d_coordinates_at_pixel_no_depth(opencv_client):
    """Test getting 3D coordinates at a pixel with no depth data."""
    intrinsics = np.array([600, 0, 320, 0, 600, 240, 0, 0, 1])
    opencv_client.camera_intrinsics = intrinsics
